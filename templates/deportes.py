...
from scraping_script import obtener_articulos_el_comercio
...
def index():
    ...
    if url and "elcomercio.pe" in url:
        try:
            articulos = obtener_articulos_el_comercio(url)

            # Filtrar artículos para la sección de deportes
            articulos = [articulo for articulo in articulos if 'deportes' in articulo['url_articulo'].lower()]
