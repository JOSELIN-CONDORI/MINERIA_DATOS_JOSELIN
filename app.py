...
from scraping_script import obtener_articulos_el_comercio, obtener_articulos_diario_sin_fronteras, obtener_articulos_diario_los_andes
...
def index():
    ...
    if url:
        try:
            ...
            elif "losandes.com.pe" in url:
                articulos = obtener_articulos_diario_los_andes(url)
